...
import { ChannelNames, FileAccessAPI, MoveFileRequest, NextFileResponse, SelectedDirectoryResponse, windowFileManagerKey } from './model';
...
const proxyFileManager: FileAccessAPI = {
